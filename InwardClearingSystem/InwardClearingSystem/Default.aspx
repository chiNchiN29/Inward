...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    AllowSorting="true" OnSorting="ViewAllCheck_Sorting" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="f_name" SortExpression="f_name" HeaderText="First Name" />
            <asp:BoundField DataField="m_name" SortExpression="m_name" HeaderText="Middle Name" />
            <asp:BoundField DataField="l_name" SortExpression="l_name" HeaderText="Last Name" />
